...
public class HTMLContent implements Content{
	...
	public static class HTMLContentTypeAdapter implements JsonSerializer<HTMLContent>, JsonDeserializer<HTMLContent>{

		@Override
		public HTMLContent deserialize(JsonElement json, Type typeOfT, JsonDeserializationContext context)
			...
			return new HTMLContent(uuid, lines);
		}

		@Override
		public JsonElement serialize(HTMLContent src, Type typeOfSrc, JsonSerializationContext context) {
	...
	public HTMLContent(String input) {
